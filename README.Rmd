---
title: "Bankruptcy Analysis at the Community Level"
author: "Joel P. Steadman"
date: 'Readme last updated: `r Sys.Date()`'
...
# rmarkdown::render(input='README.rmd', output_dir="./files/")
library("tidyverse")
library(readr)
library(knitr)
library(kableExtra)

predictions <- read_csv("./files/learn-output.csv")
```
